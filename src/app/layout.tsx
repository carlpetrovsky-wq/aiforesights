...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://www.aiforesights.com/api/og?data=eyJ0aXRsZSI6IkFJIEZvcmVzaWdodHMg4oCUIEEgTmV3IERhd24gSXMgSGVyZSIsImNhdGVnb3J5IjoiIiwic291cmNlIjoiQUkgRm9yZXNpZ2h0cyJ9', width: 1200, height: 630, alt: 'AI Foresights' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI Foresights — A New Dawn Is Here',
    description: 'The world of AI explained in plain English.',
    images: ['https://www.aiforesights.com/api/og?data=eyJ0aXRsZSI6IkFJIEZvcmVzaWdodHMg4oCUIEEgTmV3IERhd24gSXMgSGVyZSIsImNhdGVnb3J5IjoiIiwic291cmNlIjoiQUkgRm9yZXNpZ2h0cyJ9'],
  },
