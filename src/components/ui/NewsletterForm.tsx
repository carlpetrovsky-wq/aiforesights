    ...
    return (
      <div className="bg-brand-navy rounded-xl p-4 mb-4">
        ...
        <p className="text-[11px] text-brand-slate leading-relaxed mb-3">
          Top stories + best new tools every week. Free forever.
        </p>
        {submitted ? (
          <div className="flex items-center gap-2 text-brand-skyLight text-xs">
            <CheckCircle size={14} /> <span>You&apos;re subscribed!</span>
          </div>
        ) : (
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-brand-slate mb-4">
            Top stories + the best new AI tools delivered every week. Free forever. No spam.
          </p>
          {submitted ? (
            <div className="flex items-center gap-2 text-brand-skyLight text-sm">
              <CheckCircle size={16} /> <span>You&apos;re subscribed — check your inbox!</span>
            </div>
          ) : (
