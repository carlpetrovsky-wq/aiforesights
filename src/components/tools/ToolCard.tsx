  ...
  if (variant === 'sidebar') {
    return (
      <div className="flex items-start gap-2.5 py-2.5 border-b border-brand-border last:border-0 group cursor-pointer">
        <div className="w-8 h-8 rounded-lg bg-brand-bg border border-brand-border flex items-center justify-center text-xs font-semibold text-brand-slate shrink-0 group-hover:border-brand-sky transition-colors">
          {tool.name.charAt(0)}
        </div>
  ...
  return (
    <div className="bg-white border border-brand-border rounded-xl p-4 hover:border-brand-sky hover:shadow-sm transition-all group">
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-xl bg-brand-bg border border-brand-border flex items-center justify-center text-sm font-bold text-brand-slate shrink-0 group-hover:border-brand-sky transition-colors">
          {tool.name.charAt(0)}
        </div>
        <div className="flex-1 min-w-0">
